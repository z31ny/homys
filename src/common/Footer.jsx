...
const DEFAULTS = {
  ...
  instagramUrl: '',
  airbnbUrl: '',
  copyright: `© ${new Date().getFullYear()} — Homys\nAll Rights Reserved`,
};

const Footer = () => {
  const c = useCMS('footer', DEFAULTS);
      ...
      <div className="footer-container">
        ...
        <div className="footer-bottom">
          <div className="footer-socials">
            {(c.facebookUrl || DEFAULTS.facebookUrl) && (
              <a href={c.facebookUrl || DEFAULTS.facebookUrl} target="_blank" rel="noreferrer" className="social-icon">
