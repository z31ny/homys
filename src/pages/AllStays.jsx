...
const AllStays = () => {
  ...
  }, [propertyType, location, project, minPrice, maxPrice, checkIn, checkOut]);
  ...
  }, [propertyType, location, project, minPrice, maxPrice, checkIn, checkOut, setSearchParams]);
  ...
  const handleClearFilters = () => {
    setPropertyType(''); setLocation(''); setProject(''); setMinPrice(''); setMaxPrice('');
        ...
        {loading ? (
          ...
          <div className="stays-grid-container">
            {properties.map((stay) => {
              ...
              // Backend already computes discounted price into pricePerNight
              const effectivePPN = parseFloat(stay.pricePerNight);
              const originalPPN = hasDiscount && stay.originalPricePerNight
                ? parseFloat(stay.originalPricePerNight)
                : null;
              const AS_LABEL_META = {
              ...
              const labelMeta = AS_LABEL_META[stay.propertyLabel];
              return (
                <div
                  key={stay.id}
                ...
                >
                  ...
                  <div className="stay-img-box">
                    ...
                    />
                    {labelMeta && (
                      <span className={`as-label-badge ${labelMeta.cls}`}>
                        {labelMeta.text}
                      </span>
                    )}
                    {hasDiscount && (
