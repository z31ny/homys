...
const Login = () => {
  ...
  const cms = useCMS('auth_login', {});
  const pageTitle = cms.title || 'Welcome';
  const pageSubtitle = cms.subtitle || 'Log in to your Homys account';
  ...
  const styles = {
    page: { minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '100px 28px 60px', fontFamily: "'Encode Sans Expanded', sans-serif", ...(cms.backgroundImage ? { backgroundImage: `url(${cms.backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center' } : {}) },
