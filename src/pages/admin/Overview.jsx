...
import { Calendar, Users, DollarSign, MessageSquare, Home, Star, FileText } from 'lucide-react';
...
const Overview = () => {
  ...
  const revenueDisplay = `EGP ${Math.round(revenue).toLocaleString('en-EG')}`;
  ...
  const statCards = [
    ...
    { title: 'TOTAL REVENUE',       value: revenueDisplay,                 icon: <DollarSign  size={20} /> },
    ...
    { title: 'PENDING DOCUMENTS',   value: stats?.pendingDocs || 0,       icon: <FileText    size={20} /> },
