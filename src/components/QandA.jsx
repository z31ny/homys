...
const QandA = () => {
  ...
  const c = useCMS('home_quiz', DEFAULTS);
    ...
    <section className="q-and-a-section">
      <div className="q-and-a-container" onClick={() => navigate('/questionnaire')}>
        <div className="q-content-side">
          <div className="q-tag encode">{c.tag}</div>
          <h2 className="libre">{c.title}</h2>
          <p className="roboto">{c.subtitle}</p>
        ...
        <div className="q-visual-side">
          <img src={c.image || rect11} alt="Luxury Stay" className="q-visual-img" loading="lazy" />
